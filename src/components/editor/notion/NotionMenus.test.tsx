...
describe("block drag handle layout", () => {
  ...
  it("moves the hovered block with Arrow Down while preserving the title", async () => {
    const editor = new Editor({
      extensions: [StarterKit],
      content:
        "<h1>Protected title</h1><p>Alpha</p><p>Beta</p><p>Gamma</p>",
    });
    const controls = document.createElement("div");
    document.body.append(editor.view.dom, controls);
    const root = createRoot(controls);
