...
describe("revealNoteInFileManager", () => {
  beforeEach(() => {
    invokeMock.mockReset();
    invokeMock.mockResolvedValue(undefined);
  });

  it("asks the backend to reveal the validated note ID", async () => {
    await revealNoteInFileManager("projects/Project plan");

    expect(invokeMock).toHaveBeenCalledWith("reveal_note_in_file_manager", {
